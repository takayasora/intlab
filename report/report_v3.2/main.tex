...
本研究での、第一段階としては強化学習により、知識を複数会得していく。まず、lIDERを用いて仮想環境に静的障害物を配置する。
今回は図のように静的障害物をそれぞれ配置し、強化学習により、それぞれの障害物の回避を強化学習していく。次に、
...
SAP-netは環境入力情報とそれぞれの方策に与えられている活性値をもとに，環境に対して効果的な方策の選択を行いる．活性値は環境入力情報により活性化が促され，さらにその活性値が拡散され，閾値により想起が判断される．
